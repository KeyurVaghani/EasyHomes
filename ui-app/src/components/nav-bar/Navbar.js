...
export default function ElevateAppBar(props) {
  ...
  const [favouritesCount, setFavouritesCount] = React.useState(0); // eslint-disable-line no-unused-vars
  const [messagesCount, setMessagesCount] = React.useState(0); // eslint-disable-line no-unused-vars
